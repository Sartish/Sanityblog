...
export default function AllPosts() {
  ...
  // useEffect and sanity Client to fetch our posts
  useEffect(() => {
    sanityClient
      .fetch(
        `*[_type == "post"]{
  ...
  // Mapping over each blog posts and displaying the mainImage and title of each
  // Using link and post.slug.current, so that it sends ut tothe correct blog post
